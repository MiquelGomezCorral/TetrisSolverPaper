...
También por supuesto, se podrían usar otras técnicas exactas como A* o métodos vorazes en lugar del enfriamiento simulado para el paso de optimización local. Esto podría mejorar aún más los resultados obtenidos, aunque también incrementaría el tiempo de cómputo necesario.
